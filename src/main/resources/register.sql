...
VALUES (1, 'Сампсоньевски проспект');
...
INSERT INTO cr_person(sur_name, given_name, patronymic, date_of_birth,
            passport_seria, passport_number, passport_date, c_certificate_number, c_certificate_date)
VALUES
 ('Васильев', 'Павел', 'Николаевич', '1995-03-18', '1234', '123456', '2015-05-11', null, null),
 ('Васильева', 'Ирина', 'Петровна', '1997-08-21', '4321', '654321', '2017-09-19', null, null),
 ('Васильева', 'Евгения', 'Павловна', '2016-01-11', null, null, null, '456123', '2016-01-16'),
 ('Васильева', 'Евгения', 'Павловна', '2018-10-24', null, null, null, '321654', '2018-11-09');
